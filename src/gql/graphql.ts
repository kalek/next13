...
export type CategoryBySlugQuery = { categoryBySlug?: { name: string, products: { total: number, data: Array<{ id: string, name: string, price: number, avgRating: number, categories: Array<{ name: string }>, images: Array<{ url: string }> }> } } | null };
...
export type CollectionBySlugQuery = { collectionBySlug?: { name: string, products: Array<{ id: string, name: string, price: number, avgRating: number, categories: Array<{ name: string }>, images: Array<{ url: string }> }> } | null };
...
export type GetAllProductsQuery = { products: { total: number, data: Array<{ id: string, name: string, description: string, price: number, avgRating: number, categories: Array<{ id: string, name: string }> }> } };
...
export type ProductsGetListQuery = { products: { total: number, data: Array<{ id: string, name: string, price: number, avgRating: number, categories: Array<{ name: string }>, images: Array<{ url: string }> }> } };
...
export type SearchProductsQuery = { searchProducts: Array<{ id: string, name: string, price: number, avgRating: number, categories: Array<{ name: string }>, images: Array<{ url: string }> }> };
...
export type SuggestedProductGetListQuery = { suggestedProducts: Array<{ id: string, name: string, price: number, avgRating: number, categories: Array<{ name: string }>, images: Array<{ url: string }> }> };
...
export type ProductListItemFragmentFragment = { id: string, name: string, price: number, avgRating: number, categories: Array<{ name: string }>, images: Array<{ url: string }> };
